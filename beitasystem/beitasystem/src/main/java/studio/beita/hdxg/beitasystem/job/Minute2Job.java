package studio.beita.hdxg.beitasystem.job;
...
public class Minute2Job implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		try {
			String databaseName = "beita";
			Date date = new Date();
			SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
			String sqlName = sdf.format(date)+"-"+databaseName+".sql";
			if (exportDatabaseTool("127.0.0.1", "root", "root", "G:/Users/beita_sql", sqlName, databaseName)) {
